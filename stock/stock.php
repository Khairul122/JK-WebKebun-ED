...
<body>
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($p = mysqli_fetch_array($kebuns)) {
                                                $id = $p['id'];
                                                $kode_kebun = $p['kode_kebun'];
                                                $nama_kebun = $p['nama_kebun'];
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $kode_kebun; ?></td>
                                                    <td><?php echo $nama_kebun; ?></td>
                                                    <td>
                                                        <a href="#edit<?= $id; ?>" data-toggle="modal" class="btn btn-warning btn-sm">Edit</a>
                                                        <a href="#del<?= $id; ?>" data-toggle="modal" class="btn btn-danger btn-sm">Hapus</a>
                                                    </td>
                                                </tr>
                                                ...
                                                <div class="modal fade" id="edit<?= $id; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post" action="edit_kebun_act.php">
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Edit Kebun <?php echo $nama_kebun; ?></h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="text" id="kode_kebun" name="kode_kebun" class="form-control" value="<?php echo $kode_kebun; ?>" required>

                                                                    <label for="nama_kebun">Nama Kebun</label>
                                                                    <input type="text" id="nama_kebun" name="nama_kebun" class="form-control" value="<?php echo $nama_kebun; ?>" required>
                                                ...
                                                <div class="modal fade" id="del<?= $id; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post" action="hapus_kebun_act.php">
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Kebun <?php echo $nama_kebun; ?></h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>

                                                                <!-- Modal body -->
                                                                <div class="modal-body">
                                                                    Apakah Anda yakin ingin menghapus kebun ini dari daftar?
                                                                    <input type="hidden" name="id" value="<?= $id; ?>">
                                                                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Masukkan Data Kebun</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_kebun_act.php" method="post">
                        <div class="form-group">
                            <label>Kode Kebun</label>
                            <input name="kode_kebun" type="text" class="form-control" placeholder="Kode Kebun" required>
                        </div>
                        <div class="form-group">
                            <label>Nama Kebun</label>
                            <input name="nama_kebun" type="text" class="form-control" placeholder="Nama Kebun" required>
                        </div>
                </div>
                <div class="modal-footer">
