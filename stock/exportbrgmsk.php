...
<head>
	...
	<meta name="description" content="Laporan Timbang">
	<meta name="author" content="">
	<title>Laporan Timbang</title>
...
<body>
	...
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">Laporan Timbang</h4>
			<br />
			<table id="dataTable3" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
				...
				<tbody>
					<?php 
					$timbangs = mysqli_query($conn, "SELECT * FROM tbl_timbang ORDER BY id ASC");
					$no = 1;
					while ($t = mysqli_fetch_array($timbangs)) {
					?>
					<tr align="center">
						<td><?php echo $no++ ?></td>
