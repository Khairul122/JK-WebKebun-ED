...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Netto Inti Sawit</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $nettodata = mysqli_query($conn, "SELECT * FROM tbl_nettosawit ORDER BY id DESC");
                                                $no = 1;
                                                while ($row = mysqli_fetch_array($nettodata)) {
                                                    $id = $row['id'];
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php $tgl_terima = $row['tgl_terima'];
                                                            echo date("d-M-Y", strtotime($tgl_terima)) ?></td>
                                                        <td><?php $tgl_dikirim = $row['tgl_dikirim'];
                                                            echo date("d-M-Y", strtotime($tgl_dikirim)) ?></td>
                                                        <td><?php echo $row['no_spb'] ?></td>
                                                        <td><?php echo $row['netto_kebun'] ?></td>
                                                        <td><?php echo $row['alb'] ?></td>
                                                        <td><?php echo $row['kadar_air'] ?></td>
                                                        <td>
                                                    ...
                                                    <div class="modal fade" id="edit<?= $id; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form method="post" action="edit_nettosawit_act.php">
                                                                    <!-- Modal Header -->
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="date" id="tgl_terima" name="tgl_terima" class="form-control" value="<?php echo $row['tgl_terima'] ?>" required>

                                                                        <label for="tgl_dikirim">Tanggal Dikirim</label>
                                                                        <input type="date" id="tgl_dikirim" name="tgl_dikirim" class="form-control" value="<?php echo $row['tgl_dikirim'] ?>" required>

                                                                        <label for="no_spb">No SPB</label>
                                                                        <input type="text" id="no_spb" name="no_spb" class="form-control" value="<?php echo $row['no_spb'] ?>" required>

                                                                        <label for="netto_kebun">Netto Kebun</label>
                                                                        <input type="number" id="netto_kebun" name="netto_kebun" class="form-control" value="<?php echo $row['netto_kebun'] ?>" required>

                                                                        <label for="alb">ALB</label>
                                                                        <input type="number" id="alb" name="alb" class="form-control" value="<?php echo $row['alb'] ?>" required>

                                                                        <label for="kadar_air">Kadar Air</label>
                                                                        <input type="number" id="kadar_air" name="kadar_air" class="form-control" value="<?php echo $row['kadar_air'] ?>" required>
                                                    ...
                                                    <div class="modal fade" id="del<?= $id; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form method="post" action="hapus_nettosawit_act.php">
                                                                    <!-- Modal Header -->
                                                                    <div class="modal-header">
    ...
    <!-- modal input -->
 <!-- Modal Input Data Nettosawit -->
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Input Data Netto Sawit</h4>
            </div>
            <div class="modal-body">
                <form action="nettosawit_masuk_act.php" method="post">
                    <div class="form-group">
                        <label>Tanggal Terima</label>
                        <input name="tgl_terima" type="date" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Dikirim</label>
                        <input name="tgl_dikirim" type="date" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>No SPB</label>
                        <input name="no_spb" type="text" class="form-control" placeholder="Nomor SPB" required>
                    </div>
                    <div class="form-group">
                        <label>Netto Kebun</label>
                        <input name="netto_kebun" type="number" min="1" class="form-control" placeholder="Netto Kebun" required>
                    </div>
                    <div class="form-group">
                        <label>ALB</label>
                        <input name="alb" type="number" min="0" class="form-control" placeholder="ALB" required>
                    </div>
                    <div class="form-group">
                        <label>Kadar Air</label>
                        <input name="kadar_air" type="number" min="0" class="form-control" placeholder="Kadar Air" required>
                    </div>
            </div>
            <div class="modal-footer">
